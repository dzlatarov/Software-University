    ...
    public class HomeController : Controller
    {
        ...
        private decimal CalculateResult(Calculator calculator)
        {
            ...
            switch (calculator.Operator)
            {
                ...
                case "-":
                    result = calculator.LeftOperand - calculator.Result;
                    break;
                ...
                case "^":
                    result = (decimal) Math.Pow(Convert.ToDouble(calculator.LeftOperand), Convert.ToDouble(calculator.RightOperand));
                        break;
            }
