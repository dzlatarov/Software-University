...
public class PriceChangeAlert
{
    ...
    public static string GetMessage(decimal currentPrice, decimal lastPrice, decimal procentDiff, bool etherTrueOrFalse)
    {
    ...
    public static bool IsDif(decimal diff, decimal threshold)
    {
    ...
    public static decimal ProcentDifference(decimal lastPrice, decimal currentPrice)
    {
