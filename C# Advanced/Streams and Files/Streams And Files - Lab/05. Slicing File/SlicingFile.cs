...
internal class SlicingFile
{
    ...
    {
        Console.WriteLine(@"Input file location, name and format (E:\Music\Post Rock\If These Trees Could Talk - 2006 - If These Trees Could Talk (EP)\01 - Malabar Front.mp3 for example):");
        string inputFile = Console.ReadLine();
        Console.WriteLine(@"Output folder path (C:\Users\Xadera\Desktop\Desktop for example):");
        string folderPath = Console.ReadLine();
        Console.WriteLine(@"Number of parts:");
